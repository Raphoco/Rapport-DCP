...
Les prémices de ce projet ont été de choisir des étudiants étudiant le \textsf{Master Maths. CRYPTIS} exclusivement. Notre choix s'est porté sur des étudiants avec des profils très différents et chacun a des spécificités. Il aurait été trop facile de choisir des étudiants de la filière informatique du \textsf{Master CRYPTIS}.\\
...
Nous vous remercions pour votre œil attentif et en espérant que vous aurez apprécié autant que nous le récit de notre projet.
\end{document}